<template>
  <div class="background-component">
    <div class="highlight-title">How Can I Help You?</div>
    ...
    <div class="highlight-content">
      <highlight-card v-for="(data, index) in datas" :key="index" :title="data.title" :icon="data.icon" :description="data.description" style="width: 30%;"></highlight-card>
    </div>
  </div>
</template>

<script>
import HighlightCardVue from "./HighlightCard.vue";
export default {
  components: {
    "highlight-card": HighlightCardVue
  },
  data() {
      return{
          datas: [{
